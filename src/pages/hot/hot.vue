...
<template>
  <view class="viewport">
    ...
    <!-- 推荐列表 -->
    <scroll-view v-for="(item,index) in subTypes" @scrolltolower="onScrolltolower" :key="item.id" v-show="activeIndex===index" scroll-y class="scroll-view">
      <view class="goods">
        <navigator
          hover-class="none"
          class="navigator"
